...
import models.{UserAuthenticator, UserTableQueries, BasicUser}
 ...
 * @since 2014-08-25
 */
class DBAuthenticatorStore[A <: Authenticator[BasicUser]] extends securesocial.core.authenticator.AuthenticatorStore[A] {
                ...
                case "CookieAuthenticator" =>
                  Option(
                    CookieAuthenticator(
                      ...
                      this.asInstanceOf[DBAuthenticatorStore[CookieAuthenticator[BasicUser]]]
                    ).asInstanceOf[A]
                  )
                case "HttpHeaderAuthenticator" =>
                  Option(
                    HttpHeaderAuthenticator(
                      ...
                      userAuthenticator.lastUsed,
                      userAuthenticator.creationDate,
                      this.asInstanceOf[DBAuthenticatorStore[HttpHeaderAuthenticator[BasicUser]]]
                    ).asInstanceOf[A]
                  )
                case _ => None
              }
