...
import service.{ DemoUser, InMemoryUserService, MyEventListener, SlickUserService}
  ...
  def insert(): Unit = {
    DB.withSession { implicit s: Session =>
      ...
      if (SeriesDAO.count == 0) {
          Seq(
            Series(Option(1L), "Random 1", None, sdf.parse("2014-01-01")),
            Series(Option(2L), "Dilbert", None, sdf.parse("2014-03-19")),
            Series(Option(3L), "Calvin and Hobbs", None, sdf.parse("2014-06-21")),
            Series(Option(4L), "Garfield", None, sdf.parse("2014-07-08")),
            Series(Option(5L), "The Farside", None, sdf.parse("2014-11-05"))
      ...
      if (StoryDAO.count == 0) {
        Seq(
          Story(Option(1L), "Comic Strip 1", """
            ...
            Duis rutrum porta tortor ut convallis. Duis rutrum porta tortor ut convallis.""", Some(1), sdf.parse("2014-01-01")),
          Story(Option(2L), "Comic Strip 2", """
            Donec a fermentum nisi.""", Some(1), sdf.parse("2014-09-14")),
          Story(Option(3L), "Comic Strip 3", """
            ...
            nunc convallis quis aliquam mauris suscipit.""", Some(2), sdf.parse("2014-11-16")),
          Story(Option(4L), "Comic Strip 4", """
            Donec a fermentum nisi.""", Some(2), sdf.parse("2014-03-21")),
          Story(Option(5L), "Comic Strip 5", """
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed feugiat consectetur pellentesque. Nam acelit risus, ac blandit dui. 
            Duis rutrum porta tortor ut convallis. Duis rutrum porta tortor ut convallis.""", Some(2), sdf.parse("2014-06-21")),
          Story(Option(6L), "Comic Strip 6", """
            Donec a fermentum nisi.""", Some(3), sdf.parse("2014-02-04")),
          Story(Option(7L), "Comic Strip 7", """
            Nullam eget lectus augue. Donec eu sem sit amet ligula faucibus suscipit. Suspendisse rutrum turpis quis
            nunc convallis quis aliquam mauris suscipit.""", Some(3), sdf.parse("2014-06-08")),
          Story(Option(8L), "Comic Strip 8", """
            Donec a fermentum nisi.""", Some(3), sdf.parse("2014-06-04")),
          Story(Option(9L), "Comic Strip 9", """
            Nullam eget lectus augue. Donec eu sem sit amet ligula faucibus suscipit. Suspendisse rutrum turpis quis
            nunc convallis quis aliquam mauris suscipit.""", Some(4), sdf.parse("2014-02-09")),
          Story(Option(10L), "Comic Strip 10", """
            Donec a fermentum nisi.""", Some(4), sdf.parse("2014-09-11")),
          Story(Option(11L), "Comic Strip 11", """
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed feugiat consectetur pellentesque. Nam acelit risus, ac blandit dui. 
            Duis rutrum porta tortor ut convallis. Duis rutrum porta tortor ut convallis.""", Some(4), sdf.parse("2014-05-19")),
          Story(Option(12L), "Comic Strip 12", """
            Nullam eget lectus augue. Donec eu sem sit amet ligula faucibus suscipit. Suspendisse rutrum turpis quis
            nunc convallis quis aliquam mauris suscipit.""", Some(5), sdf.parse("2014-12-21")),
          Story(Option(13L), "Comic Strip 13", """
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed feugiat consectetur pellentesque. Nam acelit risus, ac blandit dui. 
            Duis rutrum porta tortor ut convallis. Duis rutrum porta tortor ut convallis.""", Some(5), sdf.parse("2015-01-11")),
          Story(Option(14L), "Comic Strip 14", """
            Donec a fermentum nisi.""", Some(5), sdf.parse("2015-02-13")),
          Story(Option(15L), "Comic Strip 15", """
            Nullam eget lectus augue. Donec eu sem sit amet ligula faucibus suscipit. Suspendisse rutrum turpis quis
            nunc convallis quis aliquam mauris suscipit.""", Some(5), sdf.parse("2014-07-21"))
